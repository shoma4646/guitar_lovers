...
/// プリセット練習動画データ
class PresetVideos {
  static List<PracticeVideo> get videos => [
    PracticeVideo(
      id: 'preset-1',
      videoId: 'BBz-Jyr23M4',
      title: '初心者向けコード練習 - G, C, D',
    ...
    PracticeVideo(
      ...
      videoId: 'jJxGCwrs1Ac',
      title: 'ペンタトニックスケール入門',
      category: PracticeCategory.scale,
    ),
    PracticeVideo(
      id: 'preset-3',
      videoId: '0xXjlGGFlHs',
      title: 'フィンガーピッキング基礎',
      category: PracticeCategory.fingerpicking,
    ),
    PracticeVideo(
      id: 'preset-4',
      videoId: 'aD5-rwrbYrE',
      title: 'ストローク パターン集',
      category: PracticeCategory.strumming,
    ),
    PracticeVideo(
      id: 'preset-5',
      videoId: 'rgaTLrZGlk0',
